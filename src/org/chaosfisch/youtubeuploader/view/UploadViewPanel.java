...
public final class UploadViewPanel
{
	...
	private void initComponents()
	{
		...
		fileSearchMenuItem = new JMenuItem(resourceBundle.getString("menuitem.openfile"), new ImageIcon(getClass().getResource(
		...
		visibilityList.setModel(new DefaultComboBoxModel(new String[] { resourceBundle.getString("visibilitylist.public"),
				resourceBundle.getString("visibilitylist.unlisted"), resourceBundle.getString("visibilitylist.private") }));
		commentList.setModel(new DefaultComboBoxModel(new String[] { resourceBundle.getString("commentlist.allowed"),
				resourceBundle.getString("commentlist.moderated"), resourceBundle.getString("commentlist.denied"),
				resourceBundle.getString("commentlist.friendsonly") }));
		videoresponseList.setModel(new DefaultComboBoxModel(new String[] { resourceBundle.getString("videoresponselist.allowed"),
				resourceBundle.getString("videoresponselist.moderated"), resourceBundle.getString("videoresponselist.denied") }));
	...
	private void updateInsertedFiles(final File... selectedFiles)
	{
		...
		if ((fileList.getItemCount() > 0) && titleTextField.getText().isEmpty())
		{
			...
			{
				titleTextField.setText(new String(fileList
						.getSelectedItem()
						.toString()
						.substring(fileList.getSelectedItem().toString().lastIndexOf(File.separator) + 1,
