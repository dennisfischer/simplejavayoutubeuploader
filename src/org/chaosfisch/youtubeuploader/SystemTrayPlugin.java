...
public class SystemTrayPlugin implements Pluggable
{
	...
	private final ResourceBundle	resourceBundle	= ResourceBundle
															.getBundle("org.chaosfisch.youtubeuploader.plugins.systemtrayplugin.resources.systemtrayplugin");	// NON-NLS
	...
	public void onStart()
	{
		...
		try
		{
			...
			mainFrame.addWindowListener(new WindowAdapter() {
				...
				{
					trayIcon.displayMessage(resourceBundle.getString("informationMessageLabel"),
							resourceBundle.getString("applicationMinimizedMessage"), TrayIcon.MessageType.INFO);
