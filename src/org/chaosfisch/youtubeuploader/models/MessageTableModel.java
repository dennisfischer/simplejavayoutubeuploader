...
public class MessageTableModel extends RowTableModel<Message>
{
	...
	{
		super(Message.class);
		setDataAndColumnNames(new IdentityList<Message>(), Arrays.asList(I18nHelper.message("messagetable.id"), I18nHelper.message("messagetable.message"), I18nHelper.message("messagetable.uploadid"), I18nHelper.message("messagelabel.facebook"),
		                                                                 I18nHelper.message("messagelabel.twitter"), I18nHelper.message("messagelabel.googleplus"), I18nHelper.message("messagelabel.youtube")));
