...
import org.chaosfisch.youtubeuploader.view.DirectoryViewPanel;
...
/**
 * Created by IntelliJ IDEA. User: Dennis Date: 02.03.12 Time: 17:00 To change
...
public class DirectoryPlugin implements Pluggable
{
	private static final String[]	DEPENDENCIES	= { "org.chaosfisch.youtubeuploader.plugins.settingsplugin.SettingsPlugin",
			"org.chaosfisch.youtubeuploader.plugins.coreplugin.CorePlugin" };
	private final ResourceBundle	resourceBundle	= ResourceBundle.getBundle(
															"org.chaosfisch.youtubeuploader.plugins.directoryplugin.resources.directoryplugin",
															Locale.getDefault());	// NON-NLS
	@Inject
	...
	public void onStart()
	{
		...
		final JMenuItem menuItem = new JMenuItem(resourceBundle.getString("directoryobserver.label"), new ImageIcon(getClass().getResource(
		...
		menuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e)
			{
				...
				directoryViewPanel.setIconImage(Toolkit.getDefaultToolkit().getImage(
						getClass().getResource("/youtubeuploader/resources/images/folder_explore.png")));// NON-NLS
