...
public class SimpleJavaYoutubeUploader extends Application
{
	...
	protected void initApplication(final Stage primaryStage) throws IOException
	{
		try
		{
			final DataSource dataSourceUnpooled = DataSources.unpooledDataSource("jdbc:h2:~SimpleJavaYoutubeUploader/youtubeuploader", "", "");
			...
			Base
					.exec("CREATE TABLE IF NOT EXISTS DIRECTORIES(ID INTEGER NOT NULL auto_increment PRIMARY KEY,DIRECTORY VARCHAR(255),ACTIVE BOOLEAN,LOCKED BOOLEAN,PRESET_ID INTEGER, created_at DATETIME, updated_at DATETIME);");
			Base
					.exec("CREATE TABLE IF NOT EXISTS MESSAGES(ID INTEGER NOT NULL auto_increment PRIMARY KEY,MESSAGE VARCHAR(255),QUEUE_ID INTEGER,FACEBOOK BOOLEAN,TWITTER BOOLEAN,GOOGLEPLUS BOOLEAN,YOUTUBE BOOLEAN, created_at DATETIME, updated_at DATETIME);");
			Base
					.exec("CREATE TABLE IF NOT EXISTS PRESETS(ID INTEGER NOT NULL auto_increment PRIMARY KEY,CATEGORY VARCHAR(255),COMMENT SMALLINT,COMMENTVOTE BOOLEAN, DEFAULTDIR VARCHAR(255),DESCRIPTION VARCHAR(16777216),EMBED BOOLEAN,KEYWORDS VARCHAR(16777216),MOBILE BOOLEAN,NAME VARCHAR(255),NUMBERMODIFIER SMALLINT,RATE BOOLEAN,VIDEORESPONSE SMALLINT,VISIBILITY SMALLINT,PLAYLISTS_ID VARCHAR(255),ACCOUNT_ID INTEGER,PLAYLIST_ID INTEGER,MONETIZE BOOLEAN,MONETIZEOVERLAY BOOLEAN,MONETIZETRUEVIEW BOOLEAN,MONETIZEPRODUCT BOOLEAN,ENDDIR VARCHAR(255),LICENSE SMALLINT,CLAIM BOOLEAN,CLAIMTYPE SMALLINT,CLAIMPOLICY SMALLINT,PARTNEROVERLAY BOOLEAN,PARTNERTRUEVIEW BOOLEAN,PARTNERPRODUCT BOOLEAN,PARTNERINSTREAM BOOLEAN,ASSET VARCHAR(255),WEBTITLE VARCHAR(255),WEBDESCRIPTION VARCHAR(255),WEBID VARCHAR(255),WEBNOTES VARCHAR(255),TVTMSID VARCHAR(255),TVISAN VARCHAR(255),TVEIDR VARCHAR(255),SHOWTITLE VARCHAR(255),EPISODETITLE VARCHAR(255),SEASONNB VARCHAR(255),EPISODENB VARCHAR(255),TVID VARCHAR(255),TVNOTES VARCHAR(255),MOVIETITLE VARCHAR(255),MOVIEDESCRIPTION VARCHAR(255),MOVIETMSID VARCHAR(255),MOVIEISAN VARCHAR(255),MOVIEEIDR VARCHAR(255),MOVIEID VARCHAR(255),MOVIENOTES VARCHAR(255), created_at DATETIME, updated_at DATETIME);");
			Base
					.exec("CREATE TABLE IF NOT EXISTS PLACEHOLDER(ID INTEGER NOT NULL auto_increment PRIMARY KEY,PLACEHOLDER VARCHAR(255),REPLACEMENT VARCHAR(255), created_at DATETIME, updated_at DATETIME);");
			Base
					.exec("CREATE TABLE IF NOT EXISTS PLAYLISTS(ID INTEGER NOT NULL auto_increment PRIMARY KEY,PKEY VARCHAR(255), PRIVATE BOOLEAN, TITLE VARCHAR(255),URL VARCHAR(255), NUMBER INTEGER, SUMMARY VARCHAR(16777216), ACCOUNT_ID INTEGER, created_at DATETIME, updated_at DATETIME);");
			Base
					.exec("CREATE TABLE IF NOT EXISTS QUEUE(ID INTEGER NOT NULL auto_increment PRIMARY KEY,ARCHIVED BOOLEAN,CATEGORY VARCHAR(255),COMMENT SMALLINT,COMMENTVOTE BOOLEAN,DESCRIPTION VARCHAR(16777216),EMBED BOOLEAN,FAILED BOOLEAN,FILE VARCHAR(500),VISIBILITY SMALLINT,KEYWORDS VARCHAR(16777216),MIMETYPE VARCHAR(255),MOBILE BOOLEAN,RATE BOOLEAN,TITLE VARCHAR(255),UPLOADURL VARCHAR(255),VIDEORESPONSE SMALLINT,SEQUENCE INTEGER,STARTED TIMESTAMP,INPROGRESS BOOLEAN,LOCKED BOOLEAN,VIDEOID VARCHAR(255),ACCOUNT_ID INTEGER,PLAYLISTS_ID INTEGER,PLAYLIST_ID INTEGER,MONETIZE BOOLEAN,MONETIZEOVERLAY BOOLEAN,MONETIZETRUEVIEW BOOLEAN,MONETIZEPRODUCT BOOLEAN,ENDDIR VARCHAR(255),LICENSE SMALLINT,RELEASE TIMESTAMP,NUMBER SMALLINT,CLAIM BOOLEAN,CLAIMTYPE SMALLINT,CLAIMPOLICY SMALLINT,PARTNEROVERLAY BOOLEAN,PARTNERTRUEVIEW BOOLEAN,PARTNERPRODUCT BOOLEAN,PARTNERINSTREAM BOOLEAN,ASSET VARCHAR(255),WEBTITLE VARCHAR(255),WEBDESCRIPTION VARCHAR(255),WEBID VARCHAR(255),WEBNOTES VARCHAR(255),TVTMSID VARCHAR(255),TVISAN VARCHAR(255),TVEIDR VARCHAR(255),SHOWTITLE VARCHAR(255),EPISODETITLE VARCHAR(255),SEASONNB VARCHAR(255),EPISODENB VARCHAR(255),TVID VARCHAR(255),TVNOTES VARCHAR(255),MOVIETITLE VARCHAR(255),MOVIEDESCRIPTION VARCHAR(255),MOVIETMSID VARCHAR(255),MOVIEISAN VARCHAR(255),MOVIEEIDR VARCHAR(255),MOVIEID VARCHAR(255),MOVIENOTES VARCHAR(255), PAUSEONFINISH BOOLEAN, created_at DATETIME, updated_at DATETIME);");
			Base
					.exec("CREATE TABLE IF NOT EXISTS SETTINGS(ID VARCHAR(255) NOT NULL PRIMARY KEY, VALUE VARCHAR(255), created_at DATETIME, updated_at DATETIME);");
