...
public class TwitterSocialProvider implements ISocialProvider
{
	...
	@Override public void authenticate()
	{
		...
		final String verifier = JOptionPane.showInputDialog(null, I18nHelper.message("label.acceptcode"), I18nHelper.message("label.twitteroauth"), JOptionPane.INFORMATION_MESSAGE);
