...
/**
 * Created by IntelliJ IDEA. User: Dennis Date: 05.02.12 Time: 16:07 To change
...
public class PluginServiceImpl implements PluginService
{
	...
	{
		if (extensionPointMap.containsKey(extensionType)) { return extensionPointMap.get(extensionType); }
