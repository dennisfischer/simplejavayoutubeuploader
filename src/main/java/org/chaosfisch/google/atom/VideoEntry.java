...
public class VideoEntry {
	public @XStreamAlias("yt:accessControl")
	@XStreamImplicit
	List<YoutubeAccessControl>	accessControl	= new ArrayList<YoutubeAccessControl>();
	public @XStreamAlias("app:control")
	AppControl					appControl;
	public @XStreamAlias("app:edited")
	String						appEdited;
	public YoutubeAuthor		author;
	public @XStreamAlias("category")
	@XStreamImplicit
	List<Category>				categories;
	public @XStreamAlias("gd:comments")
	GDataComments				comments;
	public YoutubeContent		content;
	public @Deprecated
	@XStreamAlias("gd:rating")
	GDataRating					gdRating;
	public @XStreamAlias("georss:where")
	YoutubeGeoRss				geoRssWhere;
	public String				id;
	public @XStreamAlias("link")
	@XStreamImplicit
	List<Feedlink>				links;
	public @XStreamAlias("yt:location")
	String						location;
	public @XStreamAlias("media:group")
	MediaGroup					mediaGroup		= new MediaGroup();
	public @XStreamAlias("yt:countHint")
	Integer						playlistCountHint;
	public @XStreamAlias("yt:playlistId")
	String						playlistId;
	public @XStreamAlias("summary")
	String						playlistSummary;
	public String				published;
	public @XStreamAlias("yt:statistics")
	...
	public @XStreamAlias("yt:availability")
	YoutubeAvailability			ytAvailability;
	public @XStreamAlias("yt:episode")
	YoutubeEpisode				ytEpisode;
	public @XStreamAlias("yt:firstReleased")
	String						ytFirstReleased;
	public @XStreamAlias("yt:hd")
	Object						ytHD;
	public @XStreamAlias("yt:noembed")
	Object						ytNoEmbed;
	public @XStreamAlias("yt:position")
	Integer						ytPosition;
	public @XStreamAlias("yt:private")
	Object						ytPrivate;
	public @XStreamAlias("yt:rating")
	YoutubeRating				ytRating;
	public @XStreamAlias("yt:recorded")
	String						ytRecorded;
}
