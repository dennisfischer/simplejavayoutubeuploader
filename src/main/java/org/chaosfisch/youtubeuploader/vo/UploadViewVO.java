...
public class UploadViewVO {
    ...
    public void reset() {
        setTemplate(GsonHelper.fromJSON(GsonHelper.toJSON(backupTemplate), Template.class));
        setUpload(GsonHelper.fromJSON(GsonHelper.toJSON(backupUpload), Upload.class));
    }
