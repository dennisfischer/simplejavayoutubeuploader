...
public class AccountController implements Initializable {
	...
	public void addAccount(final ActionEvent event) {
		final Account acc = Account.create("name", account.getText(), "password", password.getText(), "type",
				accountType.getValue().name());
	...
	public void initialize(final URL fxmlFileLocation, final ResourceBundle resources) {
		...
		columnAccounttype.setCellFactory(new Callback<TableColumn<Account, String>, TableCell<Account, String>>() {
			...
			@Override public TableCell<Account, String> call(final TableColumn<Account, String> param) {
		...
		columnActions.setCellFactory(new Callback<TableColumn<Account, Account>, TableCell<Account, Account>>() {
			...
			@Override public TableCell<Account, Account> call(final TableColumn<Account, Account> param) {
				final TableCell<Account, Account> cell = new TableCell<Account, Account>() {
					
					@Override public void updateItem(final Account item, final boolean empty) {
						super.updateItem(item, empty);
						if (empty) {
							setGraphic(null);
	...
	@EventTopicSubscriber(topic = ModelEvents.MODEL_POST_SAVED) public void onSaved(final String topic,
			final Model model) {
