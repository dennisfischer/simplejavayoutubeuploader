...
public class ActiveJdbcCellValueFactory<T extends Model, V> implements Callback<TableColumn.CellDataFeatures<T, V>, ObservableValue<V>> {
	private final String					cellName;
	private final Class<? extends Model>	parent;

	public ActiveJdbcCellValueFactory(final String cellName) {
		this.cellName = cellName;
		parent = null;
	}

	public ActiveJdbcCellValueFactory(final String cellName, final Class<? extends Model> parent) {
		this.cellName = cellName;
		this.parent = parent;
	}
