...
public class MetadataServiceImpl implements IMetadataService {
	...
	@Inject
	public MetadataServiceImpl(final IGoogleRequestSigner requestSigner, final IThumbnailService thumbnailService, final IAccountService accountService, final RequestBuilderFactory requestBuilderFactory) {
